# if Keyboard is visible then remember 
```
mInputShown=true
```
> in below code you will find the above code as true ,
 * mInputShown=true , **Indicates Keyboard is visible**
 * mInputShown=false , **Indicates Keyboard is not visible** , check the previous directory code
...
Current Input Method Manager state:
  ...
  mCurClient=ClientState{5790cb2 uid 10064 pid 29683} mCurSeq=2559
  mCurFocusedWindow=android.os.BinderProxy@d27faf softInputMode=STATE_ALWAYS_HIDDEN|ADJUST_PAN client=ClientState{5790cb2 uid 10064 pid 29683}
  ...
  mStartInputHistory:
   ...
   StartInput #2554:
    ...
    inputType=0x0 imeOptions=0x0 fieldId=0xffffffff fieldName=null actionId=0 actionLabel=null
   StartInput #2555:
    time=2024-02-25 13:16:03.770 (timestamp=426506188) reason=WINDOW_FOCUS_GAIN restarting=false
    imeToken=android.os.Binder@a53256 [com.google.android.inputmethod.latin/com.android.inputmethod.latin.LatinIME]
    targetWin=android.os.BinderProxy@16c69c7 [com.android.settings.intelligence] clientBindSeq=2556
    softInputMode=STATE_UNSPECIFIED|ADJUST_PAN
    inputType=0x90001 imeOptions=0x10000003 fieldId=0x10203df fieldName=null actionId=0 actionLabel=null
   StartInput #2556:
    time=2024-02-25 13:16:34.142 (timestamp=426536559) reason=WINDOW_FOCUS_GAIN restarting=false
    imeToken=android.os.Binder@a53256 [com.google.android.inputmethod.latin/com.android.inputmethod.latin.LatinIME]
    targetWin=android.os.BinderProxy@52ec91c [com.motorola.motodisplay] clientBindSeq=2557
    softInputMode=STATE_ALWAYS_HIDDEN|ADJUST_PAN
    inputType=0x0 imeOptions=0x0 fieldId=0xffffffff fieldName=null actionId=0 actionLabel=null
   StartInput #2557:
    time=2024-02-25 13:21:29.252 (timestamp=426831670) reason=WINDOW_FOCUS_GAIN restarting=false
    imeToken=android.os.Binder@a53256 [com.google.android.inputmethod.latin/com.android.inputmethod.latin.LatinIME]
    targetWin=android.os.BinderProxy@16c69c7 [com.android.settings.intelligence] clientBindSeq=2558
    softInputMode=STATE_UNSPECIFIED|ADJUST_PAN
    inputType=0x90001 imeOptions=0x10000003 fieldId=0x10203df fieldName=null actionId=0 actionLabel=null
   StartInput #2558:
    time=2024-02-25 13:22:04.164 (timestamp=426866581) reason=WINDOW_FOCUS_GAIN restarting=false
    imeToken=android.os.Binder@a53256 [com.google.android.inputmethod.latin/com.android.inputmethod.latin.LatinIME]
    targetWin=android.os.BinderProxy@d27faf [com.motorola.motodisplay] clientBindSeq=2559
    softInputMode=STATE_ALWAYS_HIDDEN|ADJUST_PAN
    inputType=0x0 imeOptions=0x0 fieldId=0xffffffff fieldName=null actionId=0 actionLabel=null
...
Input method client state for android.view.inputmethod.InputMethodManager@fcc2c03:
  ...
  mActive=true mRestartOnNextWindowFocus=false mBindSequence=2559 mCurId=com.google.android.inputmethod.latin/com.android.inputmethod.latin.LatinIME
  mFullscreenMode=false
  mCurMethod=com.android.internal.view.IInputMethodSession$Stub$Proxy@df506e4
  mCurRootView=android.widget.FrameLayout{1c5974d V.E...... ......ID 0,0-1080,1920}
  mServedView=android.widget.FrameLayout{1c5974d V.E...... ......ID 0,0-1080,1920}
  mNextServedView=android.widget.FrameLayout{1c5974d V.E...... ......ID 0,0-1080,1920}
...
Input method service state for com.android.inputmethod.latin.LatinIME@1def8f6:
  ...
  mInputBinding=InputBinding{android.os.BinderProxy@ceec2b2 / uid 10064 / pid 29683}
  mInputConnection=InputConnectionWrapper{idHash=#8a75203 mMissingMethods=}
  mStartedInputConnection=null
  mInputStarted=true mInputViewStarted=false mCandidatesViewStarted=false
  mStartInputToken=android.os.BinderProxy@b8d0580
  mInputEditorInfo:
    inputType=0x0 imeOptions=0x0 privateImeOptions=null
    actionLabel=null actionId=0
    initialSelStart=-1 initialSelEnd=-1 initialCapsMode=0x0
...
pref_key_latest_ime_activation_time: "1708847489294"
...
latest_activation_time: "1708847489295"
